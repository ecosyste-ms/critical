...
import { mkdir, unlink, readFile, rename } from 'fs/promises'
...
async function extractDatabase(source, destination) {
...
export { build, createDatabase, fetchAllCriticalPackages, fetchVersionNumbers, databasePath, insertRepoMetadata, extractDatabase }
